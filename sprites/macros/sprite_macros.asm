...
macro alloc_sprite_spriteset_1(sprite_id, name, init_rt, main_rt, n_oam_tiles, n_exbyte, ssfile_1, spr_1656_val, spr_1662_val, spr_166E_val, spr_167A_val, spr_1686_val, spr_190F_val)
	!{sprite_!{sid}_n_ss_files} #= 1
	!{sprite_!{sid}_ss_file_1} = <ssfile_1>
...
macro alloc_sprite_spriteset_2(sprite_id, name, init_rt, main_rt, n_oam_tiles, n_exbyte, ssfile_1, ssfile_2, spr_1656_val, spr_1662_val, spr_166E_val, spr_167A_val, spr_1686_val, spr_190F_val)
	%alloc_sprite_spriteset_1(<sprite_id>, <gfx_name>, <init_rt>, <main_rt>, <n_oam_tiles>, <n_exbyte>, <ssfile_1>, <spr_1656_val>, <spr_1662_val>, <spr_166E_val>, <spr_167A_val>, <spr_1686_val>, <spr_190F_val>)
	!{sprite_!{sid}_n_ss_files} #= !{sprite_!{sid}_n_ss_files}+1
	!{sprite_!{sid}_ss_file_2} = <ssfile_2>
endmacro

macro alloc_sprite_spriteset_3(sprite_id, name, init_rt, main_rt, n_oam_tiles, n_exbyte, ssfile_1, ssfile_2, ssfile_3, spr_1656_val, spr_1662_val, spr_166E_val, spr_167A_val, spr_1686_val, spr_190F_val)
	%alloc_sprite_spriteset_2(<sprite_id>, <gfx_name>, <init_rt>, <main_rt>, <n_oam_tiles>, <n_exbyte>, <ssfile_1>, <ssfile_2>, <spr_1656_val>, <spr_1662_val>, <spr_166E_val>, <spr_167A_val>, <spr_1686_val>, <spr_190F_val>)
	!{sprite_!{sid}_n_ss_files} #= !{sprite_!{sid}_n_ss_files}+1
	!{sprite_!{sid}_ss_file_3} = <ssfile_3>
endmacro

macro alloc_sprite_spriteset_4(sprite_id, name, init_rt, main_rt, n_oam_tiles, n_exbyte, ssfile_1, ssfile_2, ssfile_3, ssfile_4, spr_1656_val, spr_1662_val, spr_166E_val, spr_167A_val, spr_1686_val, spr_190F_val)
	%alloc_sprite_spriteset_3(<sprite_id>, <gfx_name>, <init_rt>, <main_rt>, <n_oam_tiles>, <n_exbyte>, <ssfile_1>, <ssfile_2>, <ssfile_3>, <spr_1656_val>, <spr_1662_val>, <spr_166E_val>, <spr_167A_val>, <spr_1686_val>, <spr_190F_val>)
	!{sprite_!{sid}_n_ss_files} #= !{sprite_!{sid}_n_ss_files}+1
	!{sprite_!{sid}_ss_file_4} = <ssfile_4>
endmacro
