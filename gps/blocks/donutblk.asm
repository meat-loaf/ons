...
;based on mikeyk's code, adapted by Davros.
	...
	!CUSTOM_SPRITE = $20    ;>custom sprite number to generate
...
print "A Donut Lift, which will fall shortly after being stepped on. Use object 17 with argument (in size) 5x instead."
