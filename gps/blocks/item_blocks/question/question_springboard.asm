...
State:
db $09,$09	; Should be either $08 or $09

RAM_1540_vals:
db $00,$00	; If you use powerups, this should be $3E
...
print "A question block which spawns a springboard (uses item memory). Use extended object 1B instead."
