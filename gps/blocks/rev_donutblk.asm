...
;based on mikeyk's code, adapted by Davros.
	...
	!CUSTOM_SPRITE = $21    ;>custom sprite number to generate
...
MarioCorner:
	...
	SEP #$20		;|
	BCC Return		;/
				;>custom sprite mode. CARRY IS ALREADY SET :rage: :angery:
	LDA #!CUSTOM_SPRITE
	%spawn_sprite()
	LDA #$08
	STA !14C8,x
...
print "A Donut Lift, which will rise shortly after being stepped on. Use object 17 with argument (in size) 6x instead"
