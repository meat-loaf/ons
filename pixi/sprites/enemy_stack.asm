...
%spawn_table_start()
	...
	; entry 01 00: vert red (grey) parakoopa, grey falling plat
	%spawn_table_entry_start()
	%spawn_table_spr_entry_0_exbyte($0A, $01, $00, $01)
	...
	; entry 04 00
	%spawn_table_entry_start()
	%spawn_table_spr_entry_0_exbyte($21, $01, $00, $00)
	%spawn_table_spr_entry_0_exbyte($1C, $01, $00, $00)
	%spawn_table_entry_finish()
...
if !plat_sway
	...
	%sprite_init_do_pos_offset(!extra_byte_3,x)
...
cust_spr_stack_xoff:
;   00   01   02   03   04   05   06   07   08   09   0A   0B   0C   0D   0E   0F
db $00, $00, $00, $E8, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00 ;00-0F
