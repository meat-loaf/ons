...
..loop                                          ;  |
	...
	BEQ ..break                             ;  |
	INY #4                                  ;  | Note: practically, this always finds a slot
	CPY #$FC                                ;  |   on the first iteration, as oam slots 200-203
	BNE ..loop                              ;  |   are nearly always empty in levels.
	RTS                                     ;  |
..break                                         ; /
